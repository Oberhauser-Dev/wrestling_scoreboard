...
final themeModeNotifierProvider =
    NotifierProvider<ThemeModeNotifier, Raw<Future<ThemeMode>>>.internal(
...
final webSocketUrlNotifierProvider =
    NotifierProvider<WebSocketUrlNotifier, Raw<Future<String>>>.internal(
  WebSocketUrlNotifier.new,
  name: r'webSocketUrlNotifierProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$webSocketUrlNotifierHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final apiUrlNotifierProvider =
    NotifierProvider<ApiUrlNotifier, Raw<Future<String>>>.internal(
  ApiUrlNotifier.new,
  name: r'apiUrlNotifierProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$apiUrlNotifierHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final bellSoundNotifierProvider =
    NotifierProvider<BellSoundNotifier, Raw<Future<String>>>.internal(
  BellSoundNotifier.new,
  name: r'bellSoundNotifierProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$bellSoundNotifierHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
