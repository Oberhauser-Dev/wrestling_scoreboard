...
Packages with other changes:
 ...
 - [`wrestling_scoreboard_client` - `v0.3.7`](#wrestling_scoreboard_client---v037)
 - [`wrestling_scoreboard_common` - `v0.3.6`](#wrestling_scoreboard_common---v036)
 - [`wrestling_scoreboard_generator` - `v0.3.0+2`](#wrestling_scoreboard_generator---v0302)
 - [`wrestling_scoreboard_server` - `v0.3.7`](#wrestling_scoreboard_server---v037)

---

#### `wrestling_scoreboard_client` - `v0.3.7`
 ...
 - **REFACTOR**: const for responsive container. ([7e4faeaf](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/7e4faeaf244a7147304bc2bfd7a1694605461b68))
 - **REFACTOR**: Improved Exception handling. ([ba19e5f5](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/ba19e5f530be71b20d25ac3ef5d8b057632291a5))
 - **REFACTOR**: Remove launch app data folder icon for mobiles. ([604934b8](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/604934b8fb0474e904d65af746ccf7f6a98de104))
 - **REFACTOR**: Avoid setState on save in TeamLineupEdit. ([fa687a87](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/fa687a87a1cc1993aa6bcd29ac8783a44720d03c))
 - **REFACTOR**: Remove initial data from many provider. ([81fae350](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/81fae35059c9186cac1ca3a56ce17de4df724cb8))
 - **REFACTOR**: Push replace bout route. ([b68a863e](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/b68a863ead3e6dd8572fda9266afa428c3aea9c9))
 - **REFACTOR**: Replace padding with spacing in BoutDisplay. ([a459de28](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/a459de288fd0076a9b9f13cb485b3151cf7dbc75))
 - **FIX**: Avoid updating athlete boutState when disposed. ([6cc7f5d7](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/6cc7f5d7940c0869b296516f3969ef5a10fdb1e7))
 ...
 - **FIX**: Avoid reloading weight class. ([9c33a759](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/9c33a75977f50fc2f7b5d3b438a0133ef9a7a296))
 - **FIX**: Avoid keeping items alive if not mounted ([#222](https://github.com/Oberhauser-dev/wrestling_scoreboard/issues/222)). ([7e2301b7](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/7e2301b79afc3975ca0055ee27fd4e35c3828f99))
 - **FIX**: Keep audio resource ([#222](https://github.com/Oberhauser-dev/wrestling_scoreboard/issues/222)). ([ae9adf33](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/ae9adf3300888072cf39602467992c7b2c005111))
 - **FIX**: Shortcuts for red points ([#222](https://github.com/Oberhauser-dev/wrestling_scoreboard/issues/222)). ([3890ffdb](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/3890ffdbff79ff2e16946693c5e453e290af2a37))
 - **FIX**: Do not await backupProvider if not mounted. ([3c0d1b8a](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/3c0d1b8a7d3a996461c120c1b428851c5a41edd9))
 - **FIX**: Avoid bell on end of activity time ([#231](https://github.com/Oberhauser-dev/wrestling_scoreboard/issues/231)). ([74e49f6e](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/74e49f6e798cfe198044dd0545eeea320f1ab0e2))
 - **FIX**: Only setState for AsyncButtons if still mounted. ([edc8af98](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/edc8af98ec40efedd9fcf15cda727f0dc4e4980d))
 - **FIX**: Get local data from within data manager. ([5c4003af](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/5c4003af7a9004b2943e863af6586aecca0b3a77))
 - **FIX**: Use app-specific user accessible storage across platforms. ([60611a70](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/60611a70077bc8fcafd9503a241fb41e4ad2163d))
 ...
 - **FIX**: Hide activity time for greco style bouts. ([330fd46a](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/330fd46aa39c56104330211686b04757977c7039))
 - **FIX**: Avoid dropdown selection on vacant wrestler ([#222](https://github.com/Oberhauser-dev/wrestling_scoreboard/issues/222)). ([99e57471](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/99e5747187385a25f5a1963000cd09c65c806a5c))
 - **FIX**: Center name on bout display ([#222](https://github.com/Oberhauser-dev/wrestling_scoreboard/issues/222)). ([e359cf00](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/e359cf00da804850eeff7a98b8f15bdb3a6e096d))
 ...
 - **FIX**: German translations for Red and Blue. ([f4033708](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/f4033708411b284c5fbaf703d0692807307d37eb))
 - **FIX**: Stop all injury timers, when bout stop watch is started. ([aa1c4c1b](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/aa1c4c1b63705379297c9fbc09ba930bcfa2979e))
 - **FIX**: Update RDB / PDF export values. ([cf4df99a](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/cf4df99a76373e478a97d5cafaba5e5886e9007b))
 - **FIX**: Use latin1 encoding for RDB export ([#1](https://github.com/Oberhauser-dev/wrestling_scoreboard/issues/1)). ([ea2e100e](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/ea2e100eafb8b47cb0b0a44ac6929cbf6360e428))
 ...
 - **FEAT**: Persist sort order of team match display ([#222](https://github.com/Oberhauser-dev/wrestling_scoreboard/issues/222)). ([6b6419ee](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/6b6419ee29068772e2b0824f069c029169bb7416))
 ...
 - **FEAT**: Make WeightClasses more apparent in Lineup Edit (closes [#199](https://github.com/Oberhauser-dev/wrestling_scoreboard/issues/199)). ([c3da33c2](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/c3da33c285afa9cb3a2b4711f9464f024e6a5be7))
 - **FEAT**: More contrasty background on display screens ([#222](https://github.com/Oberhauser-dev/wrestling_scoreboard/issues/222)). ([f4896b76](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/f4896b769c6ae5363bd1052806cca5edecce57b5))
 - **FEAT**: Loading indicator for async tasks ([#222](https://github.com/Oberhauser-dev/wrestling_scoreboard/issues/222)). ([ba4144f7](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/ba4144f7f53129ada1525d0b0ddd9462449151f1))
 ...
 - **FEAT**: Predict classification points in bout display (closes [#203](https://github.com/Oberhauser-dev/wrestling_scoreboard/issues/203)). ([b9b94b0b](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/b9b94b0b9e7d5f700c3528149400313c1cf5515b))
 - **FEAT**: Use ValueNotifier for Role Timers. ([a55969eb](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/a55969ebd70397c83aa914d8834764c2433242e8))
 ...
 - **FEAT**: Make bout display compatible with smaller screens. ([607a0f49](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/607a0f49bed55d467fa9e360a3a566e3a05223d7))
 - **FEAT**: Improve visibility of display screens. ([6fb7dfdf](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/6fb7dfdf2123394d5b96197d7c1ee60d1c2a9b94))
 - **FEAT**: DateTime form input ([#222](https://github.com/Oberhauser-dev/wrestling_scoreboard/issues/222)). ([9dc41095](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/9dc41095553eb94ab1e9da667c8a0953459a9ed2))
 - **DOCS**: Adapt doc for Bout screen. ([6887d854](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/6887d854622674f4648f15c5506b80e2468560d6))

#### `wrestling_scoreboard_common` - `v0.3.6`
...
#### `wrestling_scoreboard_generator` - `v0.3.0+2`

 - **FIX**: Keep single providers of many lists alive ([#222](https://github.com/Oberhauser-dev/wrestling_scoreboard/issues/222)). ([3f042ca0](https://github.com/Oberhauser-dev/wrestling_scoreboard/commit/3f042ca0f5d416dbdaf66add320744083d0296b2))

#### `wrestling_scoreboard_server` - `v0.3.7`
...
#### `wrestling_scoreboard_server` - `v0.3.0`
