...
extension RestrictedRouter on Router {
  ...
  void restrictedGetTwo(
    String route,
    Future<Response> Function(Request request, User? user, String arg1, String arg2) handler, [
    UserPrivilege privilege = UserPrivilege.none,
  ]) {
    get(
      route,
