...
void main() {
  ...
  final testTeamMatch = TeamMatch(
    ...
    guest: TeamLineup(team: testTeamBerchtesgaden, classificationPoints: 11),
      ...
      test('TeamMatches', () async {
        ...
        expect(teamMatchMap, {
          ...
          TeamMatch(
            ...
            no: '029013c',
            organization: organizationNRW,
            home: TeamLineup(team: testTeamBerchtesgaden, classificationPoints: 17),
            guest: TeamLineup(team: testTeamMering, classificationPoints: 10),
            league: testBayerligaSuedLeague,
            seasonPartition: 0,
