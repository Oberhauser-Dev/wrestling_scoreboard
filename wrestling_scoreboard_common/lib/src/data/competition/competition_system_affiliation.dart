...
abstract class CompetitionSystemAffiliation with _$CompetitionSystemAffiliation implements DataObject {
  ...
  const factory CompetitionSystemAffiliation({int? id, required Competition competition, int? maxContestants}) =
  ...
  Map<String, dynamic> toRaw() {
    return {if (id != null) 'id': id, 'competition_id': competition.id!, 'max_contestants': maxContestants};
  }
