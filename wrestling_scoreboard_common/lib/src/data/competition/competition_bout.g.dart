...
_CompetitionBout _$CompetitionBoutFromJson(Map<String, dynamic> json) => _CompetitionBout(
      ...
      weightCategory: CompetitionWeightCategory.fromJson(json['weightCategory'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$CompetitionBoutToJson(_CompetitionBout instance) => <String, dynamic>{
      'id': instance.id,
