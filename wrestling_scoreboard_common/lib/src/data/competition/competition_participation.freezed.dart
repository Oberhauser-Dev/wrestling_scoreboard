...
mixin _$CompetitionParticipation {
  ...
  @override
  String toString() {
    return 'CompetitionParticipation(id: $id, membership: $membership, lineup: $lineup, weightCategory: $weightCategory, weight: $weight)';
  }
}
...
class _CompetitionParticipation extends CompetitionParticipation {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$CompetitionParticipationToJson(
      this,
    );
  }
