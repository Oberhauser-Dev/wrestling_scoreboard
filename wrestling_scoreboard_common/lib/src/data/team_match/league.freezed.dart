...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? orgSyncId,  Organization? organization,  String name,  DateTime startDate,  DateTime endDate,  Division division,  int boutDays)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _League() when $default != null:
return $default(_that.id,_that.orgSyncId,_that.organization,_that.name,_that.startDate,_that.endDate,_that.division,_that.boutDays);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? orgSyncId,  Organization? organization,  String name,  DateTime startDate,  DateTime endDate,  Division division,  int boutDays)  $default,) {final _that = this;
switch (_that) {
case _League():
return $default(_that.id,_that.orgSyncId,_that.organization,_that.name,_that.startDate,_that.endDate,_that.division,_that.boutDays);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? orgSyncId,  Organization? organization,  String name,  DateTime startDate,  DateTime endDate,  Division division,  int boutDays)?  $default,) {final _that = this;
switch (_that) {
case _League() when $default != null:
return $default(_that.id,_that.orgSyncId,_that.organization,_that.name,_that.startDate,_that.endDate,_that.division,_that.boutDays);case _:
  return null;
