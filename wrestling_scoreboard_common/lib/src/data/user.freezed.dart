...
/// Adds pattern-matching-related methods to [SecuredUser].
extension SecuredUserPatterns on SecuredUser {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SecuredUser value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SecuredUser value)  $default,){
final _that = this;
switch (_that) {
case _SecuredUser():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SecuredUser value)?  $default,){
final _that = this;
switch (_that) {
case _SecuredUser() when $default != null:
return $default(_that);case _:
