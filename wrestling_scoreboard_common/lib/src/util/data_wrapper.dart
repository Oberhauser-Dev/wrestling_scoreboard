...
String getTableNameFromType(Type t) {
  return switch (t) {
    ...
    const (TeamMatchParticipation) => 'participation',
    const (AthleteBoutState) => 'participant_state',
    const (Person) => 'person',
...
Type getTypeFromTableName(String tableName) {
  return switch (tableName) {
    ...
    'participation' => TeamMatchParticipation,
    'participant_state' => AthleteBoutState,
    'person' => Person,
