...
Future<int?> handleGenericJson(
  ...
  return switch (type) {
    ...
    const (Competition) => handleJson<Competition>(json,
        ...
        handleSingleRaw: handleSingleRaw,
        handleManyRaw: handleManyRaw),
    const (CompetitionBout) => handleJson<CompetitionBout>(json,
        handleSingle: handleSingle,
        handleMany: handleMany,
        handleSingleRaw: handleSingleRaw,
        handleManyRaw: handleManyRaw),
    const (CompetitionLineup) => handleJson<CompetitionLineup>(json,
        ...
        handleSingleRaw: handleSingleRaw,
        handleManyRaw: handleManyRaw),
    const (CompetitionPerson) => handleJson<CompetitionPerson>(json,
        handleSingle: handleSingle,
        handleMany: handleMany,
        handleSingleRaw: handleSingleRaw,
        handleManyRaw: handleManyRaw),
    const (CompetitionSystemAffiliation) => handleJson<CompetitionSystemAffiliation>(json,
        handleSingle: handleSingle,
        handleMany: handleMany,
        handleSingleRaw: handleSingleRaw,
        handleManyRaw: handleManyRaw),
    ...
    const (Team) => handleJson<Team>(json,
        ...
        handleSingleRaw: handleSingleRaw,
        handleManyRaw: handleManyRaw),
    const (TeamClubAffiliation) => handleJson<TeamClubAffiliation>(json,
        handleSingle: handleSingle,
        handleMany: handleMany,
        handleSingleRaw: handleSingleRaw,
        handleManyRaw: handleManyRaw),
